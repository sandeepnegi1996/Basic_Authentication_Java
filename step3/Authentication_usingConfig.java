...
/*
    Here we will be storing password in one config file which is json
*/
public class Authentication_usingConfig{


    //now check from the config file
   ...
   //get the password from the json config file 
   //take the password convert to hash compare it with password that is already stored in our json file
